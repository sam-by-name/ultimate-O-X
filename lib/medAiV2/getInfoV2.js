...
(isOwned, playable, mini, aiDb, arr, ai, player, coOrds, boo) => {
  let winOrDeny = []
...
const findsVictoryDeny = (arr, ai, player, coOrds, deny, tempAiDb) => {
