export const aiFirstGoScore = (x) => {
  ...
  if (x.bigContinue2) x.totScore += 0.5
  if (x.bigContinue1) x.totScore += 0.3
  if (x.bigContinueAndMultiNew) x.totScore += 0.6
  if (x.bigContinueAndNew) x.totScore += 0.4
  if (x.bigStartsMostNew) x.totScore += 0.4
  if (x.bigStartsNew) x.totScore += 0.2
...
export const ai2ndGoScore = (z, x) => {
  ...
  if (z.bigContinue2) temp += 0.5
  if (z.bigContinue1) temp += 0.3
  if (z.bigContinueAndMultiNew) temp += 0.6
  if (z.bigContinueAndNew) temp += 0.4
  if (z.bigStartsMostNew) temp += 0.4
  if (z.bigStartsNew) temp += 0.2

  if (z.zeroEffect) temp -= 0.5
  if (z.sends2Dead) temp -= 0.5
...
export const humanFirstGoScore = (y, x) => {
  ...
  if (y.bigContinue2) temp -= 0.5
  if (y.bigContinue1) temp -= 0.5
  if (y.bigContinueAndMultiNew) temp -= 0.6
  if (y.bigContinueAndNew) temp -= 0.4
  if (y.bigStartsMostNew) temp -= 0.4
  if (y.bigStartsNew) temp -= 0.2

  if (y.zeroEffect) temp += 0.5
  if (y.sends2Dead) temp += 0.5
  if (y.harikari) temp += 1000
  x.push(temp)
}
