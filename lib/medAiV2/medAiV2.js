...
import {findsHumanVictory, findsAiVictory, findsVictory} from './lib/findsVictories'
...
const findsHighestScore = (moves) => {
  moves.sort((a, b) => a.totScore < b.totScore)
...
const gradesMoves = (arr, allPlayable, ai, human, aiDb) => {
  ...
  let allHuVics = findsVictory(arr, ai, human, aiDb, false)
  findsVictory(arr, ai, human, aiDb, true)
...
const humanTurn = (arr, ai, human, x) => {
  ...
  findsVictory(arr, ai, human, huDb, false)
  let allAiVics = findsVictory(arr, ai, human, huDb, true)
...
const aiTurn = (arr, ai, human, x) => {
  ...
  let allHuVics = findsVictory(arr, ai, human, aiDb2, false)
  findsVictory(arr, ai, human, aiDb2, true)
