...
const findsAiVictory = (arr, ai, human, aiDb) => { // finds mini that human needs to win
  let aiVics = 0
...
const isMoveHarikari = (aiDb, toPlay, x, allOpVics, boo) => {
  let vic
